function expadd(exp) {
    ...
    if(exp=="workExp"){
        exphtml="<div style=\"background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;\" class=\"panel-body3 expbox\">\n" +
            ...
            "<div class=\"col-sm-9\">\n" +
            "<input class=\"form-control required\" type=\"text\" name=\"workExp[company][]\"  aria-expanded=\"false\" aria-owns=\"typeahead-268-5645\">\n"+
            "</div>\n" +
            "</div>\n" +
            "<div class=\"form-group\">\n" +
    ...
    if(exp=="eduExp"){
        exphtml = '<div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">\n' +
            ...
            '<label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>\n' +
            '<div class="col-sm-10">\n' +
            '<input class="form-control text-center timerinput required" id="eduyearFrom" type="text" placeholder="年-月"   onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})" readonly="readonly" name="eduExp[starttime][]"><span>-&gt;</span>\n' +
            '<input class="form-control text-center timerinput required" id="eduyearEnd" type="text" placeholder="年-月"    onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})"  readonly="readonly" name="eduExp[endtime][]">\n' +
            '</div>\n' +
            '</div>\n' +
            '<div class="form-group" >\n' +
            '<label class="col-sm-2 control-label">学校名称<span class="text-danger">*</span></label>\n' +
            '<div class="col-sm-9">\n' +
            '<input class="form-control required" type="text" name="eduExp[schoolName][]">\n' +
            '</div>\n' +
            '</div>\n' +
            '<div class="form-group">\n' +
            '<label class="col-sm-2 control-label">专业<span class="text-danger">*</span></label>\n' +
            '<div class="col-sm-3">\n' +
            '<input class="form-control required" type="text" id="majorName" name="eduExp[majorName][]" >\n' +
            '</div>\n' +
    ...
    if(exp=="projectExp"){
        exphtml = '<div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">\n' +
            ...
            '<label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>\n' +
            '<div class="col-sm-10">\n' +
            '<input class="form-control text-center timerinput required" id="projectyearFrom" type="text" placeholder="年-月"   onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})" readonly="readonly" name="projectExp[starttime][]"><span>-&gt;</span>\n' +
            '<input class="form-control text-center timerinput required" id="projectyearEnd" type="text" placeholder="年-月"    onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})"  readonly="readonly" name="projectExp[endtime][]">\n' +
            '</div>\n' +
            '</div>\n' +
            '<div class="form-group" >\n' +
            '<label class="col-sm-2 control-label">项目名称<span class="text-danger">*</span></label>\n' +
            '<div class="col-sm-9">\n' +
            '<input class="form-control required" type="text" name="projectExp[proName][]">\n' +
            '</div>\n' +
            '</div>\n' +
            '<div class="form-group">\n' +
            '<label class="col-sm-2 control-label">所在公司<span class="text-danger">*</span></label>\n' +
            '<div class="col-sm-4">\n' +
            '<input class="form-control required" type="text" id="proCompany" name="projectExp[proCompany][]">\n' +
            '</div>\n' +
            '</div>\n'+
            '<div class="form-group">\n' +
...
function addPro(d) {
    var exphtml = '<div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">\n' +
        ...
        '<label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-10">\n' +
        '<input class="form-control text-center timerinput required" id="projectyearFrom" type="text" placeholder="年-月" value="'+d.startDateStr+'"  onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})" readonly="readonly" name="projectExp[starttime][]"><span>-&gt;</span>\n' +
        '<input class="form-control text-center timerinput required" id="projectyearEnd" type="text" placeholder="年-月"  value="'+d.endDateStr+'"  onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})"  readonly="readonly" name="projectExp[endtime][]">\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group" >\n' +
        '<label class="col-sm-2 control-label">项目名称<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-9">\n' +
        '<input class="form-control required" type="text" value="'+d.proName+'" id="proName" name="projectExp[proName][]">\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group">\n' +
        '<label class="col-sm-2 control-label">所在公司<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-4">\n' +
        '<input class="form-control required" type="text"  value="'+d.subCompany+'" id="proCompany" name="projectExp[proCompany][]">\n' +
        '</div>\n' +
        '</div>\n'+
        '<div class="form-group">\n' +
        '<label class="col-sm-2 control-label">项目职位<span class="text-danger"></span></label>\n' +
        '<div class="col-sm-4">\n' +
        '<input class="form-control required" type="text"  value="'+d.projectOffice+'" id="proOffice" name="projectExp[proOffice][]" >\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group">\n' +
        '<label class="col-sm-2 control-label">项目描述<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-9">\n' +
        '<textarea class="msd-elastic form-control required" name="projectExp[proDes][]" style="min-height: 136px; overflow: hidden; word-wrap: break-word; resize: none; height: 136px;">'+d.proDes.replace(/[\r\n]/g,"")+'</textarea>\n' +
        '</div>\n' +
        '</div>\n' +
        '<button class="btn col-sm-offset-2 btn-danger btn-xs deletebtn" type="button" >删除</button>\n' +
        '</div>';
...
function addWork(d) {
   var exphtml="<div style=\"background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;\" class=\"panel-body3 expbox\">\n" +
        ...
        "<label class=\"col-sm-2 control-label\">时间<span class=\"text-danger\">*</span></label>\n" +
        "<div class=\"col-sm-9\">\n" +
        "<input class=\"form-control text-center required\" id=\"experienceStartInputOption\" type=\"text\" value='"+d.startDateStr+"' style=\"width:120px; display:inline;height: 25px;background: #ffffff\" placeholder=\"年-月\"   onFocus=\"WdatePicker({dateFmt:'yyyy-MM',maxDate:'2038-01-01'})\" readonly=\"readonly\" name='workExp[starttime][]'><span>-&gt;</span>\n" +
        "<input class=\"form-control text-center required\" id=\"experienceEndInputOption\" type=\"text\" value='"+d.endDateStr+"' style=\"width:120px; display:inline;height: 25px;background: #ffffff\" placeholder=\"年-月\"    onFocus=\"WdatePicker({dateFmt:'yyyy-MM',maxDate:'2038-01-01'})\"  readonly=\"readonly\"  name='workExp[endtime][]'>\n" +
        "<div class=\"checkbox checkbox-info checkbox-inline\" style=\"vertical-align: baseline;\">\n" +
        "<input type=\"checkbox\">\n" +
        "<label>目前在职<span class=\"text-danger\">*</span></label>\n" +
        "</div>\n" +
...
function addEdu(d) {
    var  exphtml = '<div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">\n' +
        ...
        '<label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-10">\n' +
        '<input class="form-control text-center timerinput required" id="eduyearFrom" type="text" placeholder="年-月" value="'+d.startDateStr+'"  onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})" readonly="readonly" name="eduExp[starttime][]"><span>-&gt;</span>\n' +
        '<input class="form-control text-center timerinput required" id="eduyearEnd" type="text" placeholder="年-月"  value="'+d.endDateStr+'"  onFocus="WdatePicker({dateFmt:\'yyyy-MM\',maxDate:\'2038-01-01\'})"  readonly="readonly" name="eduExp[endtime][]">\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group" >\n' +
        '<label class="col-sm-2 control-label">学校名称<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-9">\n' +
        '<input class="form-control required" type="text" value="'+d.schoolName+'"  name="eduExp[schoolName][]">\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group">\n' +
        '<label class="col-sm-2 control-label">专业<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-3">\n' +
        '<input class="form-control required" type="text" id="majorName" value="'+d.majorName+'"  name="eduExp[majorName][]">\n' +
        '</div>\n' +
        '<label class="col-sm-2 control-label">学历<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-3">\n' +
        '<select class="form-control required"  id="degree" name="eduExp[degree][]" aria-required="true" data-value="'+d.degree+'">\n' +
        '<option value="高中以下">高中以下</option>\n' +
        '<option value="高中">高中</option>\n' +
        '<option value="中专">中专</option>\n' +
        '<option value="专科">专科</option>\n'+
...
function faddEdu() {
    var htmls='<div class="panel panel-default" style="padding-top: 20px;margin-right: 20px;">\n' +
        ...
        '<label class="col-sm-2 control-label">学校名称<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-9">\n' +
        '<input class="form-control required" type="text" name="eduExp[schoolName][]" id="schoolName">\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group">\n' +
        '<label class="col-sm-2 control-label">专业<span class="text-danger">*</span></label>\n' +
...
function faddPro() {
    var htmls='<div class="panel panel-default" style="padding-top: 20px;margin-right: 20px;">\n' +
        ...
        '<label class="col-sm-2 control-label">项目名称<span class="text-danger">*</span></label>\n' +
        '<div class="col-sm-9">\n' +
        '<input class="form-control required" type="text" id="proName" name="projectExp[proName][]">\n' +
        '</div>\n' +
        '</div>\n' +
        '<div class="form-group">\n' +
        '<label class="col-sm-2 control-label">所在公司<span class="text-danger">*</span></label>\n' +
