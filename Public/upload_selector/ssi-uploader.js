...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
         ...
         '<button class="btn btn-primary ssi-button" type="button">' + this.language.chooseFiles + '</button>' +
         '</span>').append(element);
        var $uploadBtn = $('<button id="ssi-uploadBtn" class="btn btn-primary ssi-button success ssi-hidden" >' +
        ...
        if (!this.options.preview) {
            ...
            $uploadBox = $('<div id="ssi-previewBox" class="ssi-uploadBox ssi-previewBox ' + (this.options.dropZone ? 'ssi-dropZonePreview ssi-dropZone"><img src=""><div id="ssi-DropZoneBack">' + this.language.drag + '</div>' : '">') + '</div>');
        ...
        function setupReader() {
            ...
            if (thisS.options.preview) {
                var getTemplate = function (content) {
                    return '<table class="table ssi-imgToUploadTable ssi-pending">' +
                     '<tr width="100%"><td>' + cutFileName(filename, ext, 15) + '</td><td><div id="ssi-uploadProgress' + index + '" class="ssi-hidden ssi-uploadProgress"></div></td>' +
                     '<td><button data-delete="' + index + '" class=" ssi-button error ssi-removeBtn"><span class="fa fa-trash-o fa-lg"></span></button></td>' +
                     '</tr></table>'
                };
