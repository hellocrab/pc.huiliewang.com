	...
	class ContractViewModel extends ViewModel {
		...
		public function _initialize(){
			...
			$this->viewFields = array(
				...
				'user'=>array('full_name'=>'owner_name', '_on'=>'contract.owner_role_id=user.role_id','_type'=>'LEFT'),
                'role'=>array('position_id','_on'=>'contract.creator_role_id=role.role_id','_type'=>'LEFT'),
