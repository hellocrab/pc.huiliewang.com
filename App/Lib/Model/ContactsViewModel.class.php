	...
	class ContactsViewModel extends ViewModel {
		public function _initialize(){
			...
			$this->viewFields = array(  
				...
				'customer'=>array('name'=>'customer_name','owner_role_id', '_on'=>'RContactsCustomer.customer_id=customer.customer_id','_type'=>'LEFT'),
                'user'=>array('full_name'=>'user_name', '_on'=>'contacts.creator_role_id=user.role_id')
			);
		}
	} 