	...
	class ProjectViewModel extends ViewModel{
		...
		public function _initialize(){
			...
			$this->viewFields = array(
                ...
                'resume'=>array('eid','name','creator_role_id','curCompany'=>'current_company','curDepartment'=>'current_department','curPosition'=>'current_job','sex','curSalary','wantsalary'=>'hope_salary','telephone','edu','job_class','_on'=>'resume.eid=fine_project.resume_id','_type'=>'LEFT'),
