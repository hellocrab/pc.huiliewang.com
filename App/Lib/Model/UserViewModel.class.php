<?php 
	class UserViewModel extends ViewModel{
		public $viewFields = array(
			...
			'role_department'=>array('name'=>'department_name','department_label','parent_id'=>'part_parent_id', '_on'=>'role_department.department_id=position.department_id','_type'=>'LEFT'),
            'professionhunters_range'=>array('lowachievment','upachievment','_on'=>'professionhunters_range.rankid=user.job_rank','_type'=>''),
			);
	}