...
class SettingAction extends Action{
    ...
    public function fields(){
        ...
        $model_array = array('leads','customer','contacts','product','business','contract','invoice','resume','resume_project','resume_edu','resume_work');
    ...
    public function fieldEdit(){
        ...
        if($this->isPost()){
            ...
            }else if($field_info['form_type'] == 'district'){
                $field_info['form_type_name'] = L('DISTRICT');
            }else if($field_info['form_type'] == 'indutrys'){
                $field_info['form_type_name'] = L('INDUSTRYS');
            }else if($field_info['form_type'] == 'job'){
                $field_info['form_type_name'] = L('JOB');
            }
    ...
    public function boxField(){
        if($this->_get("model")=="product"){
            $model= "resume";
        }else{
            $model= $this->_get("field");
        }

        $field_list = M('Fields')->where(array('model'=>$model,'field'=>$this->_get("field")))->getField('setting');
