...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
	protected $config  =	array('header'=>'条记录','prev'=>'&laquo; 上一页','next'=>'下一页 &raquo;','first'=>'首页','last'=>'末页','theme'=>' <div style="margin: 10px auto;"><div style="width:auto;float:right;margin-left:15px;line-height: 30px;">%go%页</div><div style="width:auto;height:30px;float:right;margin:2px 0px 0px 15px"><div><ul class="pagination"  id="dd1" style="float:right;margin-top:0px"><li>%upPage%</li><li>%linkPage%</li><li>%downPage%</li></ul></div></div><div style="width:auto;float:right;margin-top:7px;margin-left:35px">共%totalRow% %header% %nowPage%/%totalPage% 页</div></div> ');
    // 默认分页变量名
    public $varPage;
    ...
    public function show() {
        ...
        */
        ...
        $thego = '<select style="width:auto;display:inline-block;" id="go_page" class="form-control input-sm" name="'.$this->varPage.'" >';
