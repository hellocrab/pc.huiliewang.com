...
class THttpClient extends TTransport {
    ...
    public function flush() {
        ...
        if (@fopen('http://' . $host . $this->uri_, 'r', false, $contextid)) {
            $this->handle_ = @fopen('http://' . $host . $this->uri_, 'r', false, $contextid);
        } elseif (@fopen('https://' . $host . $this->uri_, 'r', false, $contextid)) {
            $this->handle_ = @fopen('https://' . $host . $this->uri_, 'r', false, $contextid);
        }

//    var_dump(fopen($this->scheme_.'://'.$host.$this->uri_, 'r', false, $contextid));exit;
        // Connect failed?
