...
<script>
                ...
                <div class="title-bar" style="position: relative;z-index: 99;">
                    ...
                    <div class="row " id="title-show" >
                        ...
                        <form id="searchForm" class="form-group" method="get" style="margin-bottom: 0px;">
                            ...
                            <input type="hidden" name="a" value="internet" />
                            <input type="hidden" name="via" value="internet">
                            <div class="nav pull-left" style="margin:2px 0 0 15px;width: 165px;">
                                <div class="input-group">
                                    <select class="form-control select2" style="min-width:165px;max-width: 165px;height: 0px;" name="position_info" id="position_info" >
                                        ...
                                        <option class="all" value="1" <?php if(($_GET['position_info'] == 1) and is_numeric($_GET['position_info'])): ?>selected<?php endif; ?>>正常</option>
                                        <option class="all" value="2" <?php if($_GET['position_info'] == 2): ?>selected<?php endif; ?>>升级</option>
                                        <option class="all" value="0" <?php if(($_GET['position_info'] == 0) and is_numeric($_GET['position_info'])): ?>selected<?php endif; ?>>警告</option>
	...
	<img src="__PUBLIC__/img/exclamation_mark.png" style="margin-top:-3px;">&nbsp;&nbsp;暂无数据
                                            ...
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="controls_tr">
                                                    ...
                                                    <?php if(is_array($month_yj)): $i = 0; $__LIST__ = $month_yj;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($vo[$v]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    <td><?php echo ($vo["total"]); ?></td>
                                                    <td><?php echo ($vo["rate"]); ?>%</td>
                                                    <td>
                                                        <?php if($vo['position_info'] == -1): ?><a class="label label-danger jjstatus" style="color: white;" data-id="<?php echo ($vo['user_id']); ?>">降级 </a>
                                                            <?php elseif($vo['position_info'] == 2): ?><a class="label label-primary sjstatus" style="color: white;" data-id="<?php echo ($vo['user_id']); ?>">升级 </a>
                                                                <?php elseif($vo['position_info'] == 0): ?><span class="label label-warning ">警告</span>
                                                            <?php else: ?>
                                                            正常<?php endif; ?>
                                                    </td>
    ...
    $('.sjstatus').click(function () {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo U('integral/position_edit_net');?>",
                    data: {
                        user_id: user_id,
                        position_info: 2
                    },
