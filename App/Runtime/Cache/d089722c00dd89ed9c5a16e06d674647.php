						...
						<div class="row " id="title-show">
							...
							<ul class="breadcrum pull-right" style="margin-bottom: 0px">
								...
								<select class="form-control" onchange="window.open(this.options[this.selectedIndex].value,target='_self')" style="margin-bottom:5px;">
									...
									<option value="<?php echo U('user/index','status=1&'.$parameter);?>" <?php if($_GET['status'] == 1): ?>selected<?php endif; ?>>已激活</option>
									<option value="<?php echo U('user/index','status=3&'.$parameter);?>" <?php if($_GET['status'] == 3): ?>selected<?php endif; ?>>未激活</option>
									<option value="<?php echo U('user/index','status=2&'.$parameter);?>" <?php if($_GET['status'] == 2): ?>selected<?php endif; ?>>已停用</option>
								</select>
							</ul>
							</form>
						</div>
						...
						<div class="col-sm-12 ibox-content" style="margin-top:0px;padding:0px;">
							<div id="table_div" class="full-height-scroll" style="left:0px;top:0px;">
								<table class="table table-hover table-striped table_thead_fixed" id="tab_Test3">
									<?php if($user_list == null): ?><div style="text-align:center;color:#E4E4E4;font-size:22px;font-weight:700;padding-top:15px;">
	<img src="__PUBLIC__/img/exclamation_mark.png" style="margin-top:-3px;">&nbsp;&nbsp;暂无数据
									...
									<?php else: ?>
										...
										<?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											<td style="width:60px;">
												<div class="checkbox checkbox-primary">
													<input name="user_id[]" class="check_list" type="checkbox" value="<?php echo ($vo["user_id"]); ?>" <?php if($vo['status'] == 2): ?>rel1="1"<?php endif; ?>/>
													<label for=""></label>
												</div>
											</td>
											<td>
...
<?php if(session('?admin')): ?><div id="dialog-message2" style="display:none;" title="<?php echo L('DIALOG_ADD_DEPARTMENT');?>">
	<div class="spiner-example">
		<div class="sk-spinner sk-spinner-three-bounce">
			<div class="sk-bounce1"></div>
			<div class="sk-bounce2"></div>
...
<div id="dialog-message3" style="display:none;" title="<?php echo L('DIALOG_ADD_POSITION');?>">
	<div class="spiner-example">
		<div class="sk-spinner sk-spinner-three-bounce">
			<div class="sk-bounce1"></div>
			<div class="sk-bounce2"></div>
...
$(function(){
	...
	$("#add_role").click(function(){
		...
		$('#dialog-message3').load('<?php echo U("user/role_add");?>');
	});
	$(".role").click(function(){
