							...
							<tbody class="form-inline">
								<tr>
									<th colspan="2" style="border:none">
										<span style="font-weight:900;line-height:40px;"><?php echo L('SMTP_BASIC_SETTING');?> :</span>
									</th>
								</tr>
								<tr style="border:none">
									<td class="tdleft" style="width:150px;"><?php echo L('EMAIL_ADDRESS');?> :</td>  
									<td >
										<input  class="form-control required" aria-required="true" name="address" id="address" type="text" value="<?php echo ($smtp['MAIL_ADDRESS']); ?>"/> <span style="color:red;">*</span>
										<span >(此邮箱用于系统用户找回密码及系统发件人)</span>
									</td>
								</tr>
								<tr>
									<td class="tdleft" style="border:none"><?php echo L('SMTP_SERVER_ADDRESS');?> :</td>  
									<td style="border:none">
										<input class="form-control required" aria-required="true" value="<?php echo ($smtp['MAIL_SMTP']); ?>" id="smtp" name="smtp" type="text"> <span style="color:red;">*</span>&nbsp;&nbsp;&nbsp;&nbsp;
										<div class="checkbox checkbox-primary">
											<input value="ssl" id="secure" name="secure" type="checkbox" <?php if($smtp['MAIL_SECURE'] == 'ssl'): ?>checked="checked"<?php endif; ?>>
											<label for="">SSL</label>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td style="border:none">
										<input class="form-control required" aria-required="true" value="<?php echo (($smtp['MAIL_PORT'])?($smtp['MAIL_PORT']):25); ?>" id="port" name="port" type="text"> <span style="color:red;">*</span>
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft">登录名 :</td>  
									<td style="border:none">
										<input class="form-control required" aria-required="true" value="<?php echo ($smtp['MAIL_LOGINNAME']); ?>" id="loginName" name="loginName" type="text"/><span style="color:red;">*</span>
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft">密码 :</td>  
									<td style="border:none">
										<input class="form-control required" aria-required="true" value="<?php echo ($smtp['MAIL_PASSWORD']); ?>" id="password" name="password" type="password"><span style="color:red;">*</span>
										<span >(请填写系统邮箱对应的密码)</span>
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft"><?php echo L('TEST_EMAIL');?> :</td>  
									<td style="border:none">
										<input class="form-control" name="test_email" id="test_email" type="text"/> &nbsp; 
										<input class="btn btn-primary btn-sm" style="background:#fff;border:1px solid #e3e3e3;color:#000;" id="test" name="submit" type="button" value="<?php echo L('TEST');?>">
	...
	$('#test').click(
		function(){
			...
			if(address !='' && smtp !='' && port !='' && name!='' && pw!='' && email!=''){
				...
				alert_crm('<?php echo L("PLEASE_FILL_IN_COMPLETE_INFORMATION");?>');
			}
		}
	);
