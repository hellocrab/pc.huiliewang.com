...
<form id="form_excelImport_info" method="post" enctype="multipart/form-data">
    <table class="table table-hover form-inline">
        ...
        <tr>
            ...
            <td><p id="attachment1"><input type="file" id="file" name="excel"/></p><p style="color:red"><?php echo L('IMPORT_FILE_PLEASE_BE_SURE_TO_USE_PROPRIETARY_DATA_WHEN_THE_IMPORT_TEMPLATE');?>&nbsp;<a href="<?php echo U('integral/excelImportDownload');?>"><?php echo L('NOKIA_MONITOR_TEST');?></a></p></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
...
<div id="importcontent" style="display:none">
    ...
    <div style="float: right;">
        <a id="integral" class="btn btn-primary" href="<?php echo U('integral/index');?>">专业猎头</a>
        <a id="internet" class="btn btn-primary" href="<?php echo U('integral/internet','via=internet');?>">互联网+</a>
    </div>
</div>
...
<script type="text/javascript">
    $("#submit").click(function(){
        $("#form_excelImport_info").ajaxSubmit({
            type:'post',
            url:'<?php echo U("integral/excelImport");?>',
    ...
    function update(no,path,owner_role_id,is_jump){
        var url = "<?php echo U('integral/excelImportact','num=');?>"+no+'&path='+path+'&owner_role_id='+owner_role_id+'&is_jump='+is_jump;
        // /index.php?m=integral&a=excelImportact&num=3&path=./Uploads/201807/24/5b56c463f24979873.xls&owner_role_id=undefined&is_jump=undefined
