...
<script>
	...
	<form class="form-horizontal" id="form" role="form" action="<?php echo U('business/edit');?>" method="post" enctype="multipart/form-data">
		<input type="hidden" name="refer_url" value="<?php echo ($refer_url); ?>" />
		<input type="hidden" name="business_id" value="<?php echo ($business_info['business_id']); ?>" />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<div class="input-daterange input-group" style="height:35px;">
											<span class="input-group-addon" style="background-color:#ccc;text-align:left;"><?php echo ($business_info['code']); ?></span>
										</div>
									</div>
									<div class="col-md-2"></div>
								</div>
								<?php if(is_array($field_list['main'])): $key = 0; $__LIST__ = $field_list['main'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key; if($vo['field'] == 'status_id'): ?><!--<div class="form-group">-->
											<!--<label class="col-md-4 control-label">项目状态组：</label>-->
											<!--<div class="col-md-6">-->
												<!--<select name="status_type_id" id="type_id" class="form-control">-->
													<!--<?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
														<!--<option value="<?php echo ($vo['id']); ?>" <?php if($business_info['status_type_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo['name']); ?></option>-->
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<select name="status_id" id="status_id" class="form-control" >
													<?php if(is_array($status_list)): $i = 0; $__LIST__ = $status_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['status_id']); ?>" <?php if($vo['status_id'] == $business_info['status_id']): ?>selected<?php endif; ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
											<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 10px;">*</span></div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="hidden" name="customer_id" id="customer_id" value="<?php echo ($business_info["customer_id"]); ?>" />
												<input class="form-control required" aria-required="true" placeholder="请点击选择"  type="text" name="customer_name" id="customer_name" value="<?php echo ($business_info["customer_name"]); ?>" readonly="true" style="cursor:pointer;" title="请点击选择"/>
											</div>
											<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 10px;">*</span></div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="hidden" name="contacts_id" id="contacts_id" value="<?php echo ($business_info["contacts_id"]); ?>" />
												<input class="form-control " aria-required="true" placeholder="请点击选择" type="text" name="contacts_name" value="<?php echo ($business_info["contacts_name"]); ?>" id="contacts_name" readonly="true" style="cursor:pointer;" title="请点击选择"/>
											</div>
											<div class="col-md-2"></div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="hidden" name="joiner" id="user_id" value="<?php echo ($business_info["joiner"]); ?>" />
												<input class="form-control required" aria-required="true" placeholder="请点击选择"  type="text" name="joiner_name" id="user_name" value="<?php echo ($business_info["joiner_name"]); ?>" readonly="true" style="cursor:pointer;" title="请点击选择"/>
											</div>
											<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 10px;">*</span></div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="input-group">
													<input class="form-control" type="text" name="minage" value="<?php echo ($business_info['minage']); ?>"  onkeyup="num_input(this)"><span class="input-group-addon">~</span>
													<input class="form-control" type="text" name="maxage" value="<?php echo ($business_info['maxage']); ?>" onkeyup="num_input(this)"><span class="input-group-addon">岁</span>
												</div>
											</div>
											<div class="col-md-2"></div>
										</div>
										<?php elseif($vo['field'] == 'minsalary'): ?>
										<div class="form-group">
											<label class="col-sm-3 control-label">年薪范围：</label>
											<div class="col-md-1"></div>
											<div class="col-sm-4">
												<div class="input-group">
													<input class="form-control" type="text" name="minsalary" value="<?php echo ($business_info['minsalary']); ?>"  onkeyup="num_input(this)"><span class="input-group-addon">~</span>
													<input class="form-control" type="text" name="maxsalary" value="<?php echo ($business_info['maxsalary']); ?>"  onkeyup="num_input(this)"><span class="input-group-addon">万元</span>
												</div>
											</div>
											<div class="col-md-2"></div>
										</div>
										<?php elseif($vo['field'] == 'pro_type'): ?>
										<div class="form-group">
											<label class="col-sm-3 control-label">项目类型：</label>
											<div class="col-md-1"></div>
											<div class="col-sm-4">
												<div class="input-group">
													<span><?php echo ($business_info['pro_type']); ?></span>
												</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="input-group">
													<input class="form-control" type="text" name="minexp" value="<?php echo ($business_info['minexp']); ?>"  onkeyup="num_input(this)"><span class="input-group-addon">~</span>
													<input class="form-control" type="text" name="maxexp" value="<?php echo ($business_info['maxexp']); ?>"  onkeyup="num_input(this)"><span class="input-group-addon">年</span>
												</div>
											</div>
											<div class="col-md-2"></div>
										</div>
										...
										<div class="form-group">
											...
											<?php if($vo['form_type'] == 'textarea'): if($vo['tip_start'] == 1): ?><div class="col-md-6">
												...
												<?php elseif($vo['form_type'] == 'address' || $vo['form_type'] == 'box'): ?>
												<?php if($vo['tip_start'] == 1): ?><div class="col-md-6">
													...
													<?php else: ?>
													<div class="col-md-8">
														<?php if($vo['field'] == 'grade'): ?><input type="hidden" id="star" name="grade" value="<?php echo ($business_info['grade']); ?>">
												...
												<div class="col-md-6">
													<select name="possibility" id="possibility" class="form-control">
														<?php if(is_array($possibility_list)): $key1 = 0; $__LIST__ = $possibility_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key1 % 2 );++$key1;?><option value="<?php echo ($vo); ?>%" <?php if($business_info['possibility'] == $vo.'%'): ?>selected<?php endif; ?>><?php echo ($vo); ?>%</option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="col-md-2"></div>
												<?php elseif($vo['field'] == 'name'): ?>
												<div class="col-md-6">
													<input class="form-control required" name="name" value="<?php echo ($business_info['name']); ?>" type="text"/>
												</div>
							...
							<div class="col-md-11 add_body_form" style="margin:20px 0 0 20px;">
								<?php if(is_array($field_list['data'])): $key = 0; $__LIST__ = $field_list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><div class="form-group">
										<label class="col-md-4 control-label"><?php echo ($vo["name"]); ?>：</label>
										<?php if($vo['form_type'] == 'address' || $vo['form_type'] == 'box'): if($vo['tip_start'] == 1): ?><div class="col-md-6">
													<?php echo ($vo["html"]); ?>
												</div>
												<div class="col-md-2"><span style="color: red;line-height: 32px;margin-left: 10px;">*</span></div>
												<?php else: ?>
...
<div style="display:none" id="dialog-customer-list" title="<?php echo L('SELECT_THE_CUSTOMER');?>">
...
<div style="display:none" id="dialog-validate" title="<?php echo L('BUSINESS_OPPORTUNITIES_OF_TEST_RESULTS');?>">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#contacts_name').click(function () {
            ...
            $('#dialog-contacts-list').load("<?php echo U('contacts/radiolistdialog','id=');?>"+customer_id);
        });
