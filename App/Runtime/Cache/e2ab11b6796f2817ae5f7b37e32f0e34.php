...
<div class="wrapper wrapper-content animated fadeIn col-md-12">
    <form class="form-horizontal" id="form" role="form" action="<?php echo U('product/edit');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12 add_body" >
                    <div class="">
                        <div class="col-md-8 row" >
                            ...
                            <div  id="resume-search-form" class="col-md-11 add_body_form" style="margin-left:15px;">
                                    ...
                                    <div class="col-md-7" style="margin-left: -15px;">
                                        ...
                                        <!--<div class="col-md-4">-->
                                            <!--<div class="btn btn-default fileinput-button" style="width: 100%;">-->
                                                <!--<span>上传简历</span>-->
                                                <!--<input type="file" name="files" id="uploadresume"/>-->
                                            <!--</div>-->
                                        <!--</div>-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="hidden" name="customer_id" id="business_id" value="">
                                        <input class="form-control" placeholder="请点击选择需要加入的项目" type="text" name="business_name" id="business_name"  value="<?php echo ($resume["business_name"]); ?>" readonly="true" style="cursor:pointer;" title="请点击选择">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <!--<input  type="hidden" id="status" name="status" value="推荐客户">-->
                                    ...
                                    <div class="col-md-2 youzhi">
                                        <input  type="checkbox" name="isperfect"  <?php if($resume['isperfect']): ?>checked="checked"<?php endif; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="hidden" name="sex" class="sex" value="<?php echo ($resume["sex"]); ?>">
                                        <div class="radio radio-info radio-inline" style="margin-left: 20px;margin-right: 20px;">
                                            <input type="radio" name="sex" <?php if($resume["sex"] == 1): ?>checked="checked"<?php endif; ?> class="sex" value="1">
                                            <label for="sex">男</label>
                                        </div>
                                        <div class="radio radio-info radio-inline">
                                            <input type="radio" name="sex" class="sex" <?php if($resume["sex"] == 2): ?>checked="checked"<?php endif; ?> value="2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control text-center timerinput" id="birthday" type="text"  onFocus="WdatePicker({dateFmt:'yyyy-MM', maxDate:'2038-01-01'})" readonly="readonly" name="birthday" style="width: 100%;height: 32px;text-align: left;" value="<?php echo (date("Y-m",$resume["birthday"])); ?>">
                                    </div>
                                    <div class="col-md-2"><span style="color: red;line-height: 32px;margin-left: 10px;"></span></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control text-center timerinput" id="startWorkyear" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM',maxDate:'2038-01-01'})" readonly="readonly" name="startWorkyear" style="width: 100%;height: 32px;text-align: left;" value="<?php echo (date("Y-m",$resume["startWorkyear"])); ?>">
                                    </div>
                                    <div class="col-md-2"><span style="color: red;line-height: 32px;margin-left: 10px;"></span></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label style="display: inline-block;height: 32px;line-height: 32px;"><?php echo ($resume["telephone"]); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="edu_r" value="<?php echo ($resume["edu"]); ?>">
                                    <div class="col-md-6">
                                ...
                                <div  class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input data-selector="dqs" data-option="1" value="<?php echo ($resume["location"]); ?>" class="text required" type="text" placeholder="选择目前所在地区" id="dqs" name="location" data-ui="LocalDataUIB" style="display: none;width:100%;height:40px;" aria-required="true" required  />
                                    </div>
                                    <div class="col-md-1"><span style="color: red;line-height: 32px;margin-left: 10px;">*</span></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="curStatus_n" value="<?php echo ($resume["curStatus"]); ?>" type="hidden">
                                ...
                                <div  class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input data-selector="wantdqs" class="text" type="text" placeholder="选择期望工作城市" id="wantdqs" name="intentCity" value="<?php echo ($resume["intentCity"]); ?>" data-ui="LocalDataUIB" style="display: none;width: 100%;" />
                                    </div>
                                    <div class="col-md-1"><span style="color: red;line-height: 32px;margin-left: 10px;">*</span></div>
                                </div>
                                <div class="form-group workExp">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="panel panel-default" style="padding-top: 20px;margin-right: 20px;margin-top: 10px;">
                                            <?php if(!empty($resume_work)): if(is_array($resume_work)): $i = 0; $__LIST__ = $resume_work;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">
                                                        <div class="form-group">
                                            ...
                                            <?php else: ?>
                                                <div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>
                                                        <div class="col-sm-9">
                                ...
                                <div class="form-group eduExp">
                                    ...
                                    <div class="col-lg-9">
                                        <?php if(!empty($resume_edu)): ?><div class="panel panel-default adddefault addedu" style="display: none;" onclick="faddEdu();">
                                            ...
                                            <div class="panel panel-default" style="padding-top: 20px;margin-right: 20px;">
                                                <?php if(is_array($resume_edu)): $i = 0; $__LIST__ = $resume_edu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <select class="form-control required" id="degree" name="eduExp[degree][]" aria-required="true" data-value="<?php echo ($vo["degree"]); ?>">
                                                                <option value="专科">专科</option>
                                                                <option value="本科">本科</option>
                                                                <option value="硕士">硕士</option>
                                                                <option value="MBA/EMBA">MBA/EMBA</option>
                                ...
                                <div class="form-group projectExp">
                                    ...
                                    <div class="col-lg-9">
                                        <?php if(!empty($resume_project)): ?><div class="panel panel-default adddefault addpro" style="display: none;" onclick="faddPro();">
                                                ...
                                                <div class="panel panel-default" style="padding-top: 20px;margin-right: 20px;">
                                                    <?php if(is_array($resume_project)): $i = 0; $__LIST__ = $resume_project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="background: none;border-top: 1px solid #eeeeee;padding-top: 20px;padding-bottom: 10px;" class="panel-body3 expbox">
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">时间<span class="text-danger">*</span></label>
                                                            <div class="col-sm-10">
                                ...
                                <!--<div class="form-group">-->
                                    ...
                                    <!--<div class="col-md-6" style="position: relative;">-->
                                        <!--<textarea class="msd-elastic form-control" id="evaluate" name="evaluate" style="min-height: 136px; overflow: hidden; word-wrap: break-word; resize: none; height: 136px;"><?php echo ($resume["evaluate"]); ?></textarea>-->
                                    <!--</div>-->
                                    <!--<div class="col-md-2"></div>-->
                                <!--</div>-->
                                <!--<div class="form-group">-->
                                    ...
                                    <!--<div class="col-md-6" style="position: relative;">-->
                                        <!--<textarea class="msd-elastic form-control" id="skill" name="skill" style="min-height: 36px; overflow: hidden; word-wrap: break-word; resize: none; height: 36px;"><?php echo ($resume["skill"]); ?></textarea>-->
                                    <!--</div>-->
                                    <!--<div class="col-md-2"></div>-->
                                <!--</div>-->
                                <!--<div class="form-group">-->
                                    ...
                                    <!--<div class="col-md-6" style="position: relative;">-->
                                        <!--<textarea class="msd-elastic form-control" id="language" name="language" style="min-height: 36px; overflow: hidden; word-wrap: break-word; resize: none; height: 36px;"><?php echo ($resume["language"]); ?></textarea>-->
                                    <!--</div>-->
                                    <!--<div class="col-md-2"></div>-->
                                <!--</div>-->
...
<div style="display:none;"  id="dialog-resume" title="粘贴简历">
    <form class="">
        <div class="form-group">
            ...
            <div class="col-sm-11">
                <input class="form-control ng-pristine ng-untouched ng-valid" type="text" ng-model="file.originname">
            </div>
            <div class="col-sm-12">
                <textarea class="msd-elastic form-control" style="margin-top: 10px;height: 280px;width: 100%;outline: none;resize: none; overflow: hidden; word-wrap: break-word;"></textarea>
            </div>
        </div>
    </form>
</div>
...
//	$("#"+selector).uploadPreview({ Img: selector+"_prev", Width: 120, Height: 120 });
    ...
    $(document).ready(function(){
        ...
        //求职状态
        var cursta=$("#curStatus_n").val();
        var edu_r=$("#edu_r").val();
        $("#curStatus option").each(function () {
            if(cursta && $(this).val()==cursta){
                $(this).attr("selected","selected");
            }
        })
        $("#education option").each(function () {
            if(edu_r && $(this).val()==edu_r){
                $(this).attr("selected","selected");
            }
        })
        ...
        $("#form").validate({
            submitHandler:function(form){
                $('#save_submit').off().on("click",function(){
                    ...
                    if(dqs && jobtitles && industrys && wantdqs){
                        form.submit();
                    }
                });
            }
        ...
        $("#uploadresume").on("change",function () {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    var edu_n=content.edu_n;
                    $("#education option").each(function () {
                        if(edu_n==$(this).attr("value")){
