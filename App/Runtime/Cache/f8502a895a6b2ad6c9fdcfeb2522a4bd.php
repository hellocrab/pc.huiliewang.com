    ...
    <div class="nicescroll" style="left:0px;top:0px;">
        <table class="table table-hover dilog" id="tab_Test3" style="background:#fff;margin-bottom:0px;">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td  style="padding-left: 15px;text-align: left;" nowrap="nowrap"><a href="javascript:void(0);" class="role_info" rel=""><?php echo ($vo["full_name"]); ?></a></td>
                    <td style="min-width: 100px;"><?php echo ($vo["department_name"]); ?></td>
                    <td style="min-width: 80px;"><a href="<?php echo U('product/view','id='.$vo['eid']);?>" target="_blank"><?php echo ($vo["name"]); ?></a></td>
                    <td style="min-width: 80px;"><?php echo ($vo["telephone"]); ?></td>
                    <td style="min-width: 80px;"><?php echo ($vo["location"]); ?></td>
                    <td style="min-width: 80px;"><?php echo ($vo["curCompany"]); ?></td>
                    <td style="min-width: 80px;"><?php echo ($vo["curPosition"]); ?></td>
                    <td style="min-width: 80px;"><?php echo (date('Y-m-d',$vo["addtime"])); ?></td>
