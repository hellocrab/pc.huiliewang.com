	...
	<form id="ad_Form" class="form-horizontal m-t" method="post">
		...
		<div class="col-sm-12">
			...
			<div class="form-group ">
				...
				<div class="col-sm-6">
					<input type="text" id="jobrank_name" name="jobrank_name" rel="require" rell="职级名称" class="form-control checkit" onblur="checkform(this);" />
				</div>
