                        ...
                        <div class="col-sm-12 ibox-content" style="border-top: none;padding:0px 2px;">
                            <div id="table_div" class="full-height-scroll" style="left:0px;top:0px;">
                                <table class="table table-hover table-striped table_thead_fixed sort-list" id="tab_Test3">
                                    <?php if(!empty($department_label)): ?><thead>
                                        ...
                                        <tbody>
                                        <?php if(is_array($department_label)): $i = 0; $__LIST__ = $department_label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="controls_tr">
                                                <td><input type="hidden" class="check_list" name="field_id[]" value="<?php echo ($vo["id"]); ?>"/></td>
                                                <td><?php echo ($vo["name"]); ?></td>
                                                <td>
                                                    <?php if($vo['operating'] == 0 or $vo['operating'] == 1 ): ?><a class="edit" href="javascript:void(0)" rel="<?php echo ($vo["id"]); ?>">
                                                            <i class="fa fa-pencil" style="color:#707070;"></i>
                                                        </a>
                                                        <?php else: ?>
                                                        <i class="fa fa-pencil" style="color:#ccc;"></i><?php endif; ?> &nbsp;
                                                    <?php if($vo['operating'] == 0 or $vo['operating'] == 3 ): ?><a class="delete" href="javascript:void(0)" rel="<?php echo ($vo["id"]); ?>">
...
<script type="text/javascript">
    ...
    $(function(){
        $(".edit").click(function(){
            ...
            var url = "<?php echo U('user/departmentlabeledit','&id=');?>"+id;
            $('#Modal').modal('show');
            $('#dep_modal').load(url);
        });
            ...
            swal({
                ...
                function(isConfirm){
                    if (isConfirm) {
                        $.ajax({
                            type:'GET',
                            url: "<?php echo U('user/deldepartmentlabel','id=');?>"+id,
                            async: false,
                            success: function (data) {
                                if (data.status == 1) {
    ...
    function add_departmentlabel(obj){
        $("#dep_modal").parent().removeClass("modal-lg").addClass("modal-md");
        var url = "<?php echo U('user/departmentlabeladd');?>";
        $('#Modal').modal('show');
        $('#dep_modal').load(url);
    }
