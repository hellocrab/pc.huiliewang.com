                                ...
                                <div id="table_div" class="nicescroll" style="left:0px;top:0px;">
                                    <table class="table table-hover table-striped table_thead_fixed table-bordered" id="tab_Test3" style="background:#fff;margin-bottom:0px;">
                                        ...
                                        <tr class="tabTh" style="background: #70B4E8;color: #fff;font-size: 13px;">
                                            <td style="color: #fff;"><?php echo L('SUM_TO');?></td>
                                            <td style="min-width: 100px;color:#fff;">--------</td>
                                            <td style="min-width: 80px;color:#fff;">--------</td>
                                            <td style="color:#fff;">--------</td>
                                            <td style="min-width: 80px;color:#fff;">--------</td>
                                            <td style="min-width: 80px;color:#fff;">--------</td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['calllistNum']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['adviserNum']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['tjNum']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['interviewNum']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['presentNum']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['passNum']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['offerNum']); ?></td>
                                            <td style="min-width: 80px;color: #fff;"><?php echo ($total_report['offerdNum']); ?></td>
                                            <td style="min-width: 80px;color: #fff;"><?php echo ($total_report['enterNum']); ?></td>
                                            <td style="min-width: 80px;color: #fff;"><?php echo ($total_report['safeNum']); ?></td>
                                        </tr>
                                        <tbody>
                                        <?php if(is_array($business)): $i = 0; $__LIST__ = $business;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <td><a href="<?php echo U('business/view','id='.$vo[business_id]);?>"><?php echo ($vo["name"]); ?></a></td>
                                                <td><a href="<?php echo U('customer/view','id='.$vo[customer_id]);?>"><?php echo ($vo["customer_name"]); ?></a></td>
                                                <td><?php echo ($vo["pro_type"]); ?></td>
                                                <td><a class="role_info" rel="<?php echo ($vo["user"]["role_id"]); ?>" href="javascript:void(0)"><?php echo ($vo["user_name"]); ?></a></td>
                                                <td><?php echo ($vo["second_name"]); ?></td>
                                                <td><?php echo ($vo["department_name"]); ?></td>
                                                <td><?php echo ($vo["calllistNum"]); ?></td>
                                                <td><?php echo ($vo["adviserNum"]); ?></td>
                                                <td><?php echo ($vo["tjNum"]); ?></td>
                                                <td><?php echo ($vo["interviewNum"]); ?></td>
                                                <td><?php echo ($vo["presentNum"]); ?></td>
                                                <td><?php echo ($vo["passNum"]); ?></td>
                                                <td><?php echo ($vo["offerNum"]); ?></td>
                                                <td style="min-width: 80px;"><?php echo ($vo["offerdNum"]); ?></td>
                                                <td style="min-width: 80px;"><?php echo ($vo["enterNum"]); ?></td>
                                                <td style="min-width: 80px;"><?php echo ($vo["safeNum"]); ?></td>
