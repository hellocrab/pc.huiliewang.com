								...
								<div class="col-lg-4">
									<div class="pull-left" >
										<span style="font-size: 18px;color: #000;">
											<?php
 switch($_GET['content_id']){ case 1:$content_name = '合同金额统计';break; case 2:$content_name = '回款金额统计';break; default :$content_name = '合同金额TOP10';break; } echo $content_name; ?>
										</span>
									</div>
								</div>
								<div class="col-lg-8">
							...
							<div class="row" >
								...
								<div class="col-lg-12" >
									<ul class="nav pull-left" style="margin:2px 0 0 15px;">
										<li>
											<div class="input-group">
												<input class="form-control required Wdate" aria-required="true" type="text" name="years" onFocus="WdatePicker({dateFmt:'yyyy'})" value="<?php echo ($years); ?>" />
									...
									<?php if($_GET['content_id'] != 3): ?><ul class="nav pull-left" style="margin:2px 0 0 15px;">
										<li>
											<div class="input-group">
	...
	<img src="__PUBLIC__/img/exclamation_mark.png" style="margin-top:-3px;">&nbsp;&nbsp;暂无数据
						...
						<?php if($_GET['content_id'] == 2): ?><div id="content_2" class="th_content" style="position:relative;">
								<div id="container" style="max-width:inherit;max-height: 450px;margin: 0 auto">
									<div style="text-align:center;color:#E4E4E4;font-size:22px;font-weight:700;padding-top:15px;">
	<img src="__PUBLIC__/img/exclamation_mark.png" style="margin-top:-3px;">&nbsp;&nbsp;暂无数据
</div>
						...
						<?php if($_GET['content_id'] == 3): ?><div id="content_3" class="th_content" style="position:relative;">
...
<script type="text/javascript">
	...
	$(function () {
		...
		$('#container').highcharts({
	        ...
	        title: {
	            text: '<?php echo ($type_name); ?>'
	        },
	        subtitle: {
	            text: ''
	        },
	        xAxis: {
	            categories: [<?php echo ($contract_month); ?>],
	            crosshair: true
	        },
	        yAxis: {
	            min: 0,
	        ...
	        series: [<?php echo ($analytics_data); ?>]
	    });
	...
	$("#user_type").click(function(){
		...
		if(user_type == true){
			window.location.href = "<?php echo U('contract/analytics','content_id=1'.'&date=');?>"+date;
		}else{
			window.location.href = "<?php echo U('contract/analytics','&content_id=1'.'&date=');?>"+date+'&user_type=1';
		}
	});
