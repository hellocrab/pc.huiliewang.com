...
<script>
$(function(){
	<?php if($_GET['content_id'] == '' || $_GET['content_id'] == 1): ?>$("#table_div").height(window.innerHeight-$("#table_div").offset().top-$("#tfoot_div").height()-30);
		$(window).resize(function(){
		...
		$("#oDivL_tab_Test3").height($("#table_div").height()).width($("#oTableLH_tab_Test3").width());
		$("#oDivH_tab_Test3").height($("#oTableLH_tab_Test3").height()).width($("#table_div").width());<?php endif; ?>
});
</script>
								...
								<div class="col-lg-4">
									<div class="pull-left" >
										<span style="font-size: 18px;color: #000;">
											<?php
 switch($_GET['content_id']){ case 1:$content_name = '员工项目进展分析';break; case 2:$content_name = '客戶自定义分析';break; default :$content_name = '客戶统计报表';break; } echo $content_name; ?>
										</span>
									</div>
								</div>
								<div class="col-lg-5">
								...
								<div class="col-lg-3">
									<div class="pull-right" >
										<div class="pull-left" style="margin-right: 10px;">
											<?php if($_GET['content_id'] == 2 || $_GET['content_id'] == 3): ?><span id="i_type_zhu">
							...
							<div class="row" >
								...
								<input type="hidden" name="content_id" value="<?php echo $content_id = $_GET['content_id'] ? intval($_GET['content_id']) : 1; ?>" />
								<div class="col-lg-12" >
									<?php if($_GET['content_id'] == 2): ?><ul class="nav pull-left" style="margin:2px 0 0 0;">
											<li>
												<div class="input-group">
													<select class="form-control input-sm " style="min-width:165px;max-width: 165px;" name="field" >
														<option value="origin" <?php if($field == 'origin'): ?>selected<?php endif; ?>>客户信息来源</option>
														<?php if(is_array($fields_array)): $i = 0; $__LIST__ = $fields_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['field'] != 'origin'): ?><option value="<?php echo ($vo['field']); ?>" <?php if($field == $vo['field']): ?>selected<?php endif; ?>><?php echo ($vo['field_name']); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
											</li>
										</ul><?php endif; ?>
					...
					<div class="ibox-content" id="right_height" style="border-top: none;padding-top: 0px;">
						<?php if($_GET['content_id'] == 1 || $_GET['content_id'] == ''): ?><div id="content_1" class="th_content" style="position:relative;">
								<div id="table_div" class="nicescroll" style="left:0px;top:0px;">
									<table class="table table-hover table-striped table_thead_fixed table-bordered" id="tab_Test3" style="background:#fff;margin-bottom:0px;">
                                        ...
                                        <tr class="tabTh" style="background: #70B4E8;color: #fff;font-size: 13px;">
                                            ...
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['own_customer_count_total']); ?></td>
                                            <td style="color:#fff;"><?php echo ($total_report['success_customer_count_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['success_customer_rate_total']); ?>%</td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['own_business_count_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['success_business_count_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['success_business_rate_total']); ?>%</td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['contract_price_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['contract_average_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['receivingorder_price_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['un_receivingorder_price_total']); ?></td>
                                            <td style="min-width: 80px;color:#fff;"><?php echo ($total_report['receivingorder_rate_total']); ?>%</td>
                                            <td style="min-width: 80px;">Offer掉</td>
                                            <td style="min-width: 80px;">入职</td>
                                            <td style="min-width: 80px;">过保</td>
                                        </tr>
										<?php if(is_array($reportList)): $i = 0; $__LIST__ = $reportList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($vo['user']['number']); ?></td>
											<td><a href="<?php echo U('customer/index');?>&field=creator_role_id&search=<?php echo ($vo["user"]["role_id"]); ?>&between_date=<?php echo ($between_date); ?>"><?php echo ($vo["own_customer_count"]); ?></a></td>
											<td><a href="<?php echo U('customer/index');?>&field=owner_role_id&search=<?php echo ($vo["user"]["role_id"]); ?>&between_date=<?php echo ($between_date); ?>"><?php echo ($vo["success_customer_count"]); ?></a></td>
											<td><?php echo ($vo["success_customer_rate"]); ?>%</td>
											<td><?php echo ($vo["own_business_count"]); ?></td>
											<td><?php echo ($vo["success_business_count"]); ?></td>
											<td><?php echo ($vo["success_business_rate"]); ?>%</td>
											<td><?php echo ($vo["contract_price"]); ?></td>
											<td><?php echo ($vo["contract_average"]); ?></td>
											<td><?php echo ($vo["receivingorder_price"]); ?></td>
											<td><?php echo ($vo["un_receivingorder_price"]); ?></td>
											<td><?php echo ($vo["receivingorder_rate"]); ?>%</td>
                                            <td style="min-width: 80px;">Offer掉</td>
                                            <td style="min-width: 80px;">入职</td>
                                            <td style="min-width: 80px;">过保</td>
						...
						<?php if($_GET['content_id'] == 2): ?><div id="content_2" class="th_content full-height-scroll">
								<div id="an_chart" class="col-lg-6" style="margin-left: 5px;">
									<div id="canvas_source" style="max-width:inherit;min-width:62%; height: 450px;margin: 0 auto"><?php echo L('TEMPORARILY_NO_DATA');?></div>
									<div id="canvas_source_zhu" class="hidden" style="min-width: 500px; height: 500px;margin: 0 auto"><?php echo L('TEMPORARILY_NO_DATA');?></div>
								</div>
								<div class="col-lg-5" style="margin-left: 5px;">
									<table class="table table-hover " style="margin-top: 80px;border:1px solid #ccc;background-color: #f9f9f9;">
										<tr style="background-color: #F4F4F4;">
											<td style="border-top: none;"><?php echo ($field_name); ?></td>
											<td style="border-top: none;">个数</td>
											<td style="border-top: none;">占比</td>
										</tr>
										<?php if(is_array($field_count_list)): $i = 0; $__LIST__ = $field_count_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
...
<script type="text/javascript">
	...
	$(function () {
		<?php if($own_customer_count_total > 0): ?>var chart1; //客戶信息來源饼状图
			$('#canvas_source').highcharts({
				...
				// title: {
				// 	text: '<?php echo L('CUSTOMER_SOURCE_STATISTICS_SUM_TO',array($field['origin'],$total_report['own_customer_count']));?>'
				// },
				title :{
					text : ''
				},
	...
	$("#user_type").click(function(){
		...
		if(user_type == true){
			window.location.href = "<?php echo U('customer/analytics','content_id=1'.'&between_date=');?>"+between_date;
		}else{
			window.location.href = "<?php echo U('customer/analytics','&content_id=1'.'&between_date=');?>"+between_date+'&user_type=1';
		}
	});
