									...
									<div class="pull-right">
										...
										<div class="pull-left">
											<!-- <div class="checkbox checkbox-primary">
												<input name="user_type" id="user_type" type="checkbox" <?php if($_GET['user_type'] == ''): ?>checked="true" value=""<?php else: ?>value="1"<?php endif; ?> />
									...
									<div class="nav pull-left">
										<div class="input-group" style="margin:2px 0 0 0px;">
											<select class="form-control input-sm" name="year" >
												<?php if(is_array($year_list)): $i = 0; $__LIST__ = $year_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" <?php if($vo == ($_GET['year'] ?: date('Y'))): ?>selected<?php endif; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
									<div class="nav pull-left">
										<div class="input-group" style="margin:2px 0 0 15px;">
											<select class="form-control input-sm" name="target_type" >
												<option value="1" <?php if($_GET['target_type'] == 1): ?>selected<?php endif; ?> >销售额</option>
												<option value="2" <?php if($_GET['target_type'] == 2): ?>selected<?php endif; ?> >回款金额</option>
											</select>
										</div>
									</div>
									<div class="nav pull-left" style="margin:2px 0 0 15px;width: 165px;">
										<div class="input-group">
											<select class="form-control input-sm select2" style="min-width:165px;max-width: 165px;height: 0px;" name="department_id" id="department" onchange="changeRole()">
												...
												<?php if(is_array($departmentList)): $i = 0; $__LIST__ = $departmentList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["department_id"]); ?>" <?php if($vo['department_id'] == $_GET['department_id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
									<div class="nav pull-left" style="margin:2px 0 0 15px;width: 165px;">
										<div class="input-group">
											<select class="form-control input-sm select2" style="min-width:165px;max-width: 165px;height: 0px;" name="role_id" id="role" onchange="changeCondition()">
												<option class="all" value="all"><?php echo L('ALL');?></option>
												<?php if(is_array($roleList)): $i = 0; $__LIST__ = $roleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["role_id"]); ?>" <?php if($_GET['role_id'] == $vo['role_id']): ?>selected<?php endif; ?>><?php echo ($vo["role_name"]); ?>-<?php echo ($vo["user_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
							...
							<div id="table_div" class="nicescroll" style="left:0px;top:0px;">
								<table class="table table-hover table-striped table_thead_fixed table-bordered" id="tab_Test3" style="background:#fff;margin-bottom:0px;">
									<tr class="tabTh">
									    ...
									    <?php $__FOR_START_1746959831__=1;$__FOR_END_1746959831__=12;for($i=$__FOR_START_1746959831__;$i <= $__FOR_END_1746959831__;$i+=1){ ?><td colspan="3" style="height: 30px;text-align: center;border-left:1px solid #e7eaec;"><?php echo date('Y');?>年<?php echo ($i); ?>月</td><?php } ?>
									</tr>
									<tr class="tabTh">
										<?php $__FOR_START_1343943475__=1;$__FOR_END_1343943475__=17;for($i=$__FOR_START_1343943475__;$i <= $__FOR_END_1343943475__;$i+=1){ ?><td style="min-width: 80px;height: 30px;border-left:1px solid #e7eaec;">完成</td>
										    <td style="min-width: 80px;height: 30px;">目标</td>
										    <td style="min-width: 80px;height: 30px;">完成率</td><?php } ?>
									</tr>
									<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												<?php if($vo['role_name']): ?><td class="adjust_td" style="border-right:1px solid #e7eaec;">
											  			<?php echo ($vo["user_name"]); ?>

											  			<span class="adjust">
											  				<a href="javascript:void(0)" class="edit_target" rel="4" id="<?php echo ($vo["role_id"]); ?>">
											  					<img src="__PUBLIC__/img/bianj.png">
											  				</a>&nbsp;
											  				<!-- <a href="javascript:void(0);"><img src="__PUBLIC__/img/sahnc.png"></a> -->
											  			</span>
											  		</td>
												    <td style="border-right:1px solid #e7eaec;"><?php echo ($vo["role_name"]); ?></td>
												<?php else: ?>
													<td class="adjust_td" style="border-right:1px solid #e7eaec;">
														<img src="__PUBLIC__/img/001.png" > <?php echo ($vo["name"]); ?>

														<span class="adjust">
											  				<a href="javascript:void(0)" class="edit_target" rel="3" id="<?php echo ($vo["department_id"]); ?>">
											  					<img src="__PUBLIC__/img/bianj.png">
											  				</a>&nbsp;
											  				<!-- <a href=""><img src="__PUBLIC__/img/sahnc.png"></a> -->
											  			</span>
													</td>
											    	<td style="border-right:1px solid #e7eaec;"></td><?php endif; ?>
											    <td>
													回款金额
											    	<!--<?php if($_GET['target_type'] == 2): ?>回款金额<?php else: ?>销售额<?php endif; ?>-->
											    </td>
											    <td style="border-left:1px solid #e7eaec;"><?php echo ($vo["total_finish"]); ?></td>
											    <td><?php echo ($vo["total"]); ?></td>
											    <td <?php if($vo['total_rate'] < 100): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?> >
											    	<?php echo ($vo["total_rate"]); ?>%
											    </td>

											    <td style="border-left:1px solid #e7eaec;"><?php echo ($vo["first_quarter_finish"]); ?></td>
											    <td><?php echo ($vo["first_quarter_target"]); ?></td>
											    <td <?php if($vo['first_quarter_rate'] < 100): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?> >
											    	<?php echo ($vo["first_quarter_rate"]); ?>%
											    </td>

											    <td style="border-left:1px solid #e7eaec;"><?php echo ($vo["second_quarter_finish"]); ?></td>
											    <td><?php echo ($vo["second_quarter_target"]); ?></td>
											    <td <?php if($vo['second_quarter_rate'] < 100): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?> >
											    	<?php echo ($vo["second_quarter_rate"]); ?>%
											    </td>

											    <td style="border-left:1px solid #e7eaec;"><?php echo ($vo["third_quarter_finish"]); ?></td>
											    <td><?php echo ($vo["third_quarter_target"]); ?></td>
											    <td <?php if($vo['third_quarter_rate'] < 100): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?> >
											    	<?php echo ($vo["third_quarter_rate"]); ?>%
											    </td>

											    <td style="border-left:1px solid #e7eaec;"><?php echo ($vo["fourth_quarter_finish"]); ?></td>
											    <td><?php echo ($vo["fourth_quarter_target"]); ?></td>
											    <td <?php if($vo['fourth_quarter_rate'] < 100): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?> >
											    	<?php echo ($vo["fourth_quarter_rate"]); ?>%
											    </td>
												
												<?php $__FOR_START_1158559601__=1;$__FOR_END_1158559601__=12;for($a=$__FOR_START_1158559601__;$a <= $__FOR_END_1158559601__;$a+=1){ ?><td style="border-left:1px solid #e7eaec;"><?php echo ($vo['month'.$a.'_finish']); ?></td>
												    <td><?php echo ($vo['month'.$a.'_target']); ?></td>
												    <td <?php if($vo['month'.$a.'_rate'] < 100): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?> >
...
<script type="text/javascript">
	...
	$(".role_info").click(function(){
		...
		$('#dialog-set-target').load('<?php echo U("contract/set_target","rel=");?>'+rel);
	});
	...
	$(document).on('click','.edit_target',function(){
		...
		$('#dialog-set-target').dialog('open');
		$('#dialog-set-target').load('<?php echo U("contract/set_target","rel=");?>'+rel+"&id="+id+"&year="+year+"&target_type="+target_type);
	});
	...
	$("#user_type").click(function(){
		...
		if(user_type == true){
			window.location.href = "<?php echo U('contract/collection','content_id=1'.'&year=');?>"+year+'&type='+type;
		}else{
			window.location.href = "<?php echo U('contract/collection','&content_id=1'.'&year=');?>"+year+'&user_type=1'+'&type='+type;
		}
	});
