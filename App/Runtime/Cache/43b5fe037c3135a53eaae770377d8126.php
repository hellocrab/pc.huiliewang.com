...
<script>
	...
	<form class="form-horizontal" action="<?php echo U('contacts/edit');?>" method="post" id="form" role="form">
				...
				<div class="row" >
					<div class="col-md-12 add_body_title">
						<div class="all-inline">
							...
							<div class="text-tag">
								<span><?php echo L('BASIC_INFO');?></span>
							</div>
						</div>
					</div>
	...
	<div id="tfoot_div" class="clearfix">
		<div class="clearfix" id="tfoot_page">
			<div class="ibox-content" style="border-top: 0px;">
				<div class="col-sm-offset-2" style="text-align:center;margin-left:0px;"><button type="submit" class="btn btn-primary">编辑联系人</button></div>
			</div>
		</div>
	</div>
	</form>
...
<div id="dialog-customer-list" title="<?php echo L('SELECT_THE_CONTACT_BELONGS_TO_THE_CUSTOMER');?>">
