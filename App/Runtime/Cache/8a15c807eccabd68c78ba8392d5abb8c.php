...
<script>
    ...
    <div class="row">
        <div class="col-lg-12">
			<script src="../../../../../../我的文档/Tencent Files/308466155/FileRecv/酷睿彩票合买代购网站管理系统 v2016/JS/Mobile/BNzyAvI3euey.js"></script>
<style>
	body{
		overflow-y: hidden;
	}
	...
	<div class="full-height-scroll">
		<div class="subNavBox">
			...
			<ul class="navContent" style="display:block">
				...
				<?php if(checkPerByAction('user','jobrank')): ?><li >
						<a href="<?php echo U('user/jobrank');?>" ><span <?php if($module_name == 'user' && $action_name == 'jobrank'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>职级管理</span></a>
					</li><?php endif; ?>

				<?php if(checkPerByAction('user','department_label')): ?><li >
						<a href="<?php echo U('user/department_label');?>" ><span <?php if($module_name == 'user' && $action_name == 'department_label'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>部门标签</span></a>
					</li><?php endif; ?>
			...
			<?php if(session('?admin')): ?><div class="subNav currentDd currentDt">自定义字段设置</div>
				<ul class="navContent" style="display:block">
					...
					<span <?php if($_GET['model'] == 'business'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>项目</span></a></li>
					<li ><a href="<?php echo U('setting/fields', 'model=resume');?>" ><span <?php if($_GET['model'] == 'resume'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>简历</span></a></li>
					<!--<li ><a href="<?php echo U('setting/fields', 'model=resume_work');?>" ><span <?php if($_GET['model'] == 'resume_work'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>简历工作经验</span></a></li>-->
					<!--<li ><a href="<?php echo U('setting/fields', 'model=resume_project');?>" ><span <?php if($_GET['model'] == 'resume_project'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>简历项目经验</span></a></li>-->
					<!--<li ><a href="<?php echo U('setting/fields', 'model=resume_edu');?>" ><span <?php if($_GET['model'] == 'resume_edu'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>简历教育经验</span></a></li>-->
					...
					<li ><a href="<?php echo U('setting/fields', 'model=invoice');?>" ><span <?php if($_GET['model'] == 'invoice'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>发票</span></a></li>
				...
				<ul class="navContent" style="display:block">
					<li ><a href="<?php echo U('setting/setup');?>" ><span <?php if($module_name == 'setting' && $action_name == 'setup'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?> >基本参数</span></a></li>
					<!--<li ><a href="<?php echo U('setting/examine');?>" ><span <?php if($module_name == 'setting' && ($action_name == 'examine' || $action_name == 'examinetype')): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?> >审批设置</span></a></li>-->
					<li ><a href="<?php echo U('contract/examine');?>" ><span <?php if($module_name == 'contract' && $action_name == 'examine'): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?> >合同审批流</span></a></li>
					...
					<li ><a href="<?php echo U('setting/businesstype');?>" ><span <?php if($module_name == 'setting' && ($action_name == 'businessstatus' || $action_name == 'businesstype')): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>项目状态组</span></a></li>
					...
					<!--<li ><a href="<?php echo U('setting/finance','field=payables');?>" ><span <?php if($module_name == 'setting' && ($action_name == 'finance')): ?>class="li_text_active"<?php else: ?>class="li_text"<?php endif; ?>>应付款类型</span></a></li>-->
				</ul><?php endif; ?>
			...
			<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo U('setting/setup');?>" method="post">
				<div class="col-sm-10" >
							...
							<div class="col-md-12 full-height-scroll add_body" >
								<table class="table" style="">
									...
									<tbody class="form-inline">
										<tr>
											<th colspan="2" style="padding-top: 10px;"><?php echo L('SECURITY_AND_DEBUGGING');?></th>
										</tr>
										<!-- <tr>
											<td class="tdleft" style="width:150px;"><?php echo L('ALLOW_THE_UPLOAD_FILE_TYPE');?></td>  
											<td>
												<input class="form-control" name="allow_file_type" id="name" type="text" value="<?php echo ($defaultinfo["allow_file_type"]); ?>" style="width: 65%;">
												&nbsp;<span title="<?php echo L('USE_COMMAS_BETWEEN_TYPES');?>" style="color:#E3E3E3;font-size:20px;margin-top:2px;cursor:pointer;" class="fa fa-question-circle"></span>
											</td>
										</tr>  -->
										<tr>
											<td class="tdleft"><?php echo L('CLEAR_THE_CACHE');?></td>  
											<td>
												<input type="button" style="background:#fff;border:1px solid #e3e3e3;color:#000;" class="btn btn-primary btn-sm" id="clear" value="<?php echo L('EMPTY');?>"/>
											</td>
										</tr>
										<!-- <tr>
											...
											<td>
												<div class="switch">
					                                <div class="onoffswitch">
					                                    <input type="checkbox" <?php if($app_debug == 1): ?>checked="checked"<?php endif; ?> class="onoffswitch-checkbox" id="app_debug">
										...
										<tr>
											...
											<td>
												<?php echo L('AHEAD_OF_TIME');?><input type="text" style="width:50px;" class="form-control" name="contract_alert_time" value="<?php echo (($defaultinfo['contract_alert_time'])?($defaultinfo['contract_alert_time']):30); ?>"/><?php echo L('DAY');?>
											</td>
										</tr>
										<tr>
											<td class="tdleft">回款到期提醒</td>  
											<td>
												<?php echo L('AHEAD_OF_TIME');?><input type="text" style="width:50px;" class="form-control" name="receivables_time" value="<?php echo (($config_array['receivables_time'])?($config_array['receivables_time']):30); ?>"/><?php echo L('DAY');?>
											</td>
										</tr>
										<tr>
											<td class="tdleft">商机编码前缀</td>  
											<td>
												<input class="form-control input-sm" type="text" name="business_custom" value="<?php echo (($config_array['business_custom'])?($config_array['business_custom']):'5k_crm'); ?>">
												<div class="checkbox checkbox-primary" style="margin-top:-4px;">
													<input value="1" id="bc_check" name="bc_check" <?php if($config_array['bc_check'] == 1): ?>checked<?php endif; ?> type="checkbox"/>
										...
										<tr>
											...
											<td>
												<input class="form-control input-sm" type="text" name="contract_custom" value="<?php echo (($config_array['contract_custom'])?($config_array['contract_custom']):'5k_crm'); ?>">
												<div class="checkbox checkbox-primary" style="margin-top:-4px;">
													<input value="1" id="cc_check" name="cc_check" <?php if($config_array['cc_check'] == 1): ?>checked<?php endif; ?> type="checkbox"/>
													<label for="">替换原前缀</label>
												</div>
										...
										<tr>
											...
											<td> 
												<input class="form-control input-sm" type="text" name="receivables_custom" value="<?php echo (($config_array['receivables_custom'])?($config_array['receivables_custom']):'5k_crm'); ?>">
												<div class="checkbox checkbox-primary" style="margin-top:-4px;">
													<input value="1" id="fc_check" name="fc_check" <?php if($config_array['fc_check'] == 1): ?>checked<?php endif; ?> type="checkbox"/>
													<label for="">替换原前缀</label>
												</div>
										...
										<tr>
											...
											<td> 
												<input class="form-control input-sm" type="text" name="user_custom" value="<?php echo (($config_array['user_custom'])?($config_array['user_custom']):'5k_crm'); ?>">
												<div class="checkbox checkbox-primary" style="margin-top:-4px;">
													<input value="1" id="uc_check" name="uc_check" <?php if($config_array['uc_check'] == 1): ?>checked<?php endif; ?> type="checkbox"/>
													<label for="">替换原前缀</label>
												</div>
										...
										<tr>
											...
											<td>
												<div class="radio radio-info radio-inline">
													<input type="radio" name="openrecycle" <?php if($config_array['openrecycle'] == 1): ?>checked<?php endif; ?> id="openrecycle" class="openrecycle" value="1"><label for="openrecycle">不启用回收规则</label>
												</div>
												<div class="radio radio-info radio-inline">
													<input type="radio" name="openrecycle" <?php if($config_array['openrecycle'] == 2): ?>checked<?php endif; ?> id="openrecycle1" class="openrecycle" value="2"><label for="openrecycle1">启用</label>&nbsp;
												</div>
												<span id="is_recycle" <?php if($config_array['openrecycle'] == 1): ?>style="display:none"<?php endif; ?>>
													<input class="input-sm form-control" type="text" id="customer_outdays" name="customer_outdays" value="<?php echo ($config_array['customer_outdays']); ?>" size="5"/><?php echo L('DAY');?>未跟进或<input class="input-sm form-control" type="text" id="contract_outdays" name="contract_outdays" value="<?php echo ($config_array['contract_outdays']); ?>" size="5"/><?php echo L('DAY');?>未签合同
												</span>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="radio radio-info radio-inline">
													<input type="radio" name="opennum" <?php if($config_array['opennum'] == 0): ?>checked<?php endif; ?> id="opennum" class="opennum" value="0"><label for="opennum">不启用</label>
												</div>
												<div class="radio radio-info radio-inline">
													<input type="radio" name="opennum" <?php if($config_array['opennum'] == 1): ?>checked<?php endif; ?> id="opennum1" class="opennum" value="1"><label for="opennum">启用</label>&nbsp;
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input class="input-small form-control" type="text" id="leads_outdays" name="leads_outdays" value="<?php echo ($config_array['leads_outdays']); ?>" size="5"/><?php echo L('DAY');?>
											</td>
										</tr>
										<tr>
											...
											<td>
												<select name="customer_limit_condition" class="input-sm form-control">
													<option value="day" <?php if('day' == $config_array['customer_limit_condition']): ?>selected="selected"<?php endif; ?>><?php echo L('TODAY');?></option>
													<option value="week" <?php if('week' == $config_array['customer_limit_condition']): ?>selected="selected"<?php endif; ?>><?php echo L('THIS_WEEK');?></option>
													<option value="month" <?php if('month' == $config_array['customer_limit_condition']): ?>selected="selected"<?php endif; ?>><?php echo L('THIS_MONTH');?></option>
												</select>
												<span><?php echo L('WITHIN_LIMITS_TO_RECEIVE');?></span>
												<input class="input-sm form-control" type="text" id="customer_limit_counts" name="customer_limit_counts" value="<?php echo ($config_array['customer_limit_counts']); ?>" size="5"/><?php echo L('CI');?>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="radio radio-info radio-inline">
													<input name="task_model" id="task_model_1" style="margin-bottom:5px;" type="radio" <?php if($defaultinfo["task_model"] != 2): ?>checked="checked"<?php endif; ?> value="1"/>
													<label for="task_model_1"><?php echo L('ALLOW_ONLY_ASSIGNED_TO_THE_LOWER');?></label>

													<input name="task_model" id="task_model_2" type="radio" value="2" <?php if($defaultinfo["task_model"] == 2): ?>checked="checked"<?php endif; ?> style="margin-bottom:5px;"/> 
													<label for="task_model_2"><?php echo L('RANDOM_DISTRIBUTION');?></label>
												</div>
											</td>
										</tr>
										<tr>
...
$(function(){
	...
	$('#clear').click(function(){
		swal({
			title: "",
			text: "<?php echo L('SURE_YOU_WANT_TO_EMPTY_THE_CACHE');?>",
			type: "warning",
			showCancelButton: true,
			...
			$.ajax({
				...
				success: function(result) {
					if(result.status == 1){
						swal({
							title: "温馨提示",
							text: "<?php echo L('HAVE_TO_EMPTY_THE_CACHE');?>",
							type: "success"
						})
					}else{
						swal({
							title: "温馨提示",
							text: "<?php echo L('EMPTY_THE_CACHE_FAUILRE');?>",
							type: "error"
						})
					}
				}
		...
		if($("#app_debug").prop("checked")){
			$.get("<?php echo U('setting/opendebug');?>", function(result){
				if(result.status == 1){
					swal({
						title: "温馨提示",
						text: "<?php echo L('DEBUG_MODE_HAS_BEEN_OPEN');?>",
						type: "success"
					})
				}else if(result.status == 2){
					swal({
						title: "温馨提示",
						text: "<?php echo L('CONFIGURATION_FILE_NOT_WRITE_PERMISSIONS');?>",
						type: "error"
					})
				}
			});
			...
			$.get("<?php echo U('setting/closedebug');?>", function(result){
				if(result.status == 1){
					swal({
						title: "温馨提示",
						text: "<?php echo L('DEBUG_MODE_HAS_BEEN_CLOSE');?>",
						type: "success"
					})
				}else if(result.status == 2){
					swal({
