...
<form class="form-horizontal" id="remove_form" action="<?php echo U('business/remove');?>" method="post">
...
<div class="full-height">
    <div class="content">
       <table class="beizhu">
           ...
           <tr>
               <td style="text-align: left;width: 100px;"><label style="color: red;">*</label>不合适原因:</td>
               <td style="padding-left: 20px;">
                   <textarea col="3" row="8" class="ccbeizhu" id="reason" name="reason" placeholder="最多不超过1000字" maxlength="1000"><?php echo ($list['reason']); ?></textarea>
               </td>
           </tr>
       </table>
    </div>
