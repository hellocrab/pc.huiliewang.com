											...
											<tr>
												...
												<td>
													<select name="extid" class="form-control">
														...
														<?php $__FOR_START_5972__=C('EXTID_MIN');$__FOR_END_5972__=C('EXTID_MAX');for($i=$__FOR_START_5972__;$i <= $__FOR_END_5972__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($user['extid'] == $i): ?>selected<?php endif; ?> ><?php echo ($i); ?></option><?php } ?>
													</select>
