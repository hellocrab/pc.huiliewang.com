...
<script>
	...
	<form class="form-horizontal" id="form" role="form" action="<?php echo U('contacts/add');?>" method="post">
...
<div id="dialog-customer-list" style="display:none" title="<?php echo L('SELECT_THE_CONTACT_BELONGS_TO_THE_CUSTOMER');?>">
