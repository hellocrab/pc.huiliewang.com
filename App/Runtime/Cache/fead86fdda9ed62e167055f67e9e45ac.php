								...
								<table class="table table-hover table-striped table_thead_fixed sort-list" id="tab_Test3">
									<?php if(!empty($fields)): ?><thead>
											<tr colspan="6" class="tabTh" style="background-color:#f3f3f3;line-height:42px;height:42px;">
												<td width="10%">&nbsp;</td>
												<td width="20%"><?php echo L('LABEL_NAME');?></td>
												<td width="20%"><?php echo L('FIELDS_TYPE');?></td>
												<td width="10%">是否必填</td>
												<td width="20%">列表显示</td>
										...
										<tbody>
										<?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="controls_tr">
												<td><input type="hidden" class="check_list" name="field_id[]" value="<?php echo ($vo["field_id"]); ?>"/></td>
												<td><?php echo ($vo["name"]); ?></td>
												<td>
													<?php if($vo['form_type'] == 'box'): echo L('SELECTED');?>
													<?php elseif($vo['form_type'] == 'editor'): echo L('THE_EDITOR');?>
													<?php elseif($vo['form_type'] == 'text'): echo L('SINGLE_LINE_TEXT');?>
													<?php elseif($vo['form_type'] == 'textarea'): echo L('MULTILINE_TEXT');?>
													<?php elseif($vo['form_type'] == 'datetime'): echo L('DATE');?>
													<?php elseif($vo['form_type'] == 'number'): echo L('NUMBER');?>
													<?php elseif($vo['form_type'] == 'floatnumber'): echo L('NUMBER');?>
													<?php elseif($vo['form_type'] == 'user'): echo L('USERS');?>
													<?php elseif($vo['form_type'] == 'address'): echo L('ADDRESS');?>
													<?php elseif($vo['form_type'] == 'phone'): echo L('TELEPHONE');?>
													<?php elseif($vo['form_type'] == 'mobile'): echo L('PHONE');?>
													<?php elseif($vo['form_type'] == 'email'): echo L('EMAIL');?>
													<?php else: ?><span style="color:red;"><?php echo L('SPECIAL_FIELD_ACCESS_IS_LIMITED');?></span><?php endif; ?>
												</td>
												<td><?php echo ($vo['is_null']); ?></td>
												<td>
													<?php if($vo['form_type'] != 'user'): ?><div class="radio radio-info radio-inline">
															<input type="radio" class="indexShow" name="in_index_<?php echo ($vo['field_id']); ?>" id="<?php echo ($vo["field"]); ?>_1" rel="<?php echo ($vo["field_id"]); ?>" <?php if($vo['in_index'] == 1): ?>checked<?php endif; ?> /><label for="<?php echo ($vo["field"]); ?>_1">是&nbsp;&nbsp;</label>
														</div>
														<div class="radio radio-info radio-inline" style="margin-left: 0px;padding-left: 10px;">
															<input type="radio" class="indexShow" name="in_index_<?php echo ($vo['field_id']); ?>" id="<?php echo ($vo["field"]); ?>_0" rel="<?php echo ($vo["field_id"]); ?>" <?php if($vo['in_index'] == 0): ?>checked<?php endif; ?> />&nbsp;&nbsp;<label for="<?php echo ($vo["field"]); ?>_0">否</label>
														</div><?php endif; ?>												
												</td>
												<td>
													<?php if($vo['operating'] == 0 or $vo['operating'] == 1 ): ?><a class="edit" href="javascript:void(0)" rel="<?php echo ($vo["field_id"]); ?>">
															<i class="fa fa-pencil" style="color:#707070;"></i>
														</a>
													<?php else: ?>
														<i class="fa fa-pencil" style="color:#ccc;"></i><?php endif; ?> &nbsp;
													<?php if($vo['operating'] == 0 or $vo['operating'] == 3 ): ?><a class="delete" href="javascript:void(0)" rel="<?php echo ($vo["field_id"]); ?>">
															<i class="fa fa-times" style="color:#707070;"></i>
														</a>
													<?php else: ?>
														<i class="fa fa-times" style="color:#ccc;"></i><?php endif; ?> &nbsp;
													<?php if($vo['form_type'] == 'b_box'): ?><a href="<?php echo U('setting/businesstype');?>"><?php echo L('SPECIAL_SETTING');?></a><?php endif; ?>
													<?php if($vo['model'] == 'contacts' && ($vo['field'] == 'name' || $vo['field'] == 'telephone')): if($vo['is_show'] == 0): ?><a href="<?php echo U('setting/customeshow','id=1&field_id='.$vo['field_id']);?>" title="客户列表显示" ><span class="fa fa-toggle-off" style="color:#ccc;"></span></a>
														<?php else: ?>
															<a href="<?php echo U('setting/customeshow','id=2&field_id='.$vo['field_id']);?>" title="客户列表不显示" ><span class="fa fa-toggle-on" style="color:#ccc;"></span></a><?php endif; endif; ?>
												</td>
...
<div class="" style="display:none;" id="dialog_field_add" title="<?php echo L('ADD_FIELDS');?>">
...
<div class="" style="display:none;" id="dialog_field_edit" title="<?php echo L('EDIT_FIELDS');?>">
	<div class="spiner-example">
		<div class="sk-spinner sk-spinner-three-bounce">
			<div class="sk-bounce1"></div>
			<div class="sk-bounce2"></div>
	...
	$('.delete').click(function(){
		...
		function(isConfirm){
	        if (isConfirm) {
	        	$.ajax({
		            type:'GET',
		            url: "<?php echo U('setting/fielddelete','field_id=');?>"+id,
		            async: false,
		            success: function (data) {
						if (data.status == 1) {
