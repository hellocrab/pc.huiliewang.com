					...
					<div class="ibox-content mar-top" style="border-bottom:none;padding-top:20px;">
						<div class="bulk-actions align-left">
							...
							<div class="pull-right">
								<a class="btn btn-primary" id="add">添加沟通类型</a>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12 ibox-content" style="margin-top:0px;padding:0px;">
							<div class="full-height-scroll" id="table_div" style="left:0px;top:0px;">
								<table class="table table-hover table-striped table_thead_fixed" id="tab_Test3" >
									<?php if(!empty($status_list)): ?><thead>
										<tr class="tabTh">
									...
									<tbody>
										<?php if(is_array($status_list)): $i = 0; $__LIST__ = $status_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												...
												<td>
													<a class="edit" href="javascript:void(0)" rel="<?php echo ($vo['id']); ?>"><?php echo L('EDIT');?></a>&nbsp;&nbsp;
													<a class="view" href="<?php echo U('setting/logreply','status_id='.$vo['id']);?>">查看自定义回复</a>
												</td>
...
<div class="" style="display:none;" id="dialog-add" title="添加沟通类型">
...
<div class="" style="display:none;" id="dialog-edit" title="编辑沟通类型">
	<div class="spiner-example">
		<div class="sk-spinner sk-spinner-three-bounce">
			<div class="sk-bounce1"></div>
			<div class="sk-bounce2"></div>
...
$(function(){
	...
	$("#add").click(function(){
		...
		$('#dialog-add').load('<?php echo U("setting/logstatusadd");?>');
	});

	$(".edit").click(function(){
		var id = $(this).attr('rel');
		$('#dialog-edit').dialog('open');
		$('#dialog-edit').load('<?php echo U("setting/logstatusedit","id=");?>'+id);
	});
})
	...
	if(id_array.length == 0){
		...
		function(isConfirm){
	        if (isConfirm) {
				$.ajax({
					type: "POST",
					url: "<?php echo U('setting/logstatusdel');?>",
