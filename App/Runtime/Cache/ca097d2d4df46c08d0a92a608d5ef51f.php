						...
						<div class="col-sm-12 ibox-content" style="margin-top:0px;padding:0px;">
							<div class="full-height-scroll" id="table_div" style="left:0px;top:0px;">
								<table class="table table-hover table-striped table_thead_fixed" id="tab_Test3" >
									...
									<tbody>
										<?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												...
												<td>
													...
													<a class="view" href="<?php echo U('setting/businessstatus','type_id='.$vo['id']);?>">查看商机状态</a>
												</td>
...
$(function(){
	...
	$("#add").click(function(){
		...
		$('#dialog-add').load('<?php echo U("setting/businesstypeadd");?>');
	});

	$(".edit").click(function(){
		var id = $(this).attr('rel');
		$('#dialog-edit').dialog('open');
		$('#dialog-edit').load('<?php echo U("setting/businesstypeedit","id=");?>'+id);
	});
})
	...
	if(id_array.length == 0){
		...
		function(isConfirm){
	        if (isConfirm) {
				$.ajax({
					type: "POST",
					url: "<?php echo U('setting/businesstypedel');?>",
