...
<script>
	...
	<img src="__PUBLIC__/img/exclamation_mark.png" style="margin-top:-3px;">&nbsp;&nbsp;暂无数据
                                                ...
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="controls_tr">
                                                       ...
                                                       <td>
                                                           <?php if($vo['position_info'] == -1 and ($vo['current_month'] == 6 or $vo['current_month'] == 12)): ?><a class="label label-danger jjstatus" style="color: white;" data-id="<?php echo ($vo['user_id']); ?>">降级 </a>
                                                           <?php elseif($vo['position_info'] == 1 ): ?><a class="label label-primary sjstatus" style="color: white;" data-id="<?php echo ($vo['user_id']); ?>">升级 </a>
                                                           <?php else: ?>
                                                               正常<?php endif; ?>
                                                       </td>
                                                       <!--<td>10</td>-->
