...
<div class="col-sm-2 ibox-title" style="background-color:#fff;padding-bottom:5px;" id="left_height">
	<div class="full-height-scroll">
		<div class="subNavBox">
			...
			<div class="col-lg-10 ">
				<div class="ibox-content clearfix" id="right_height" style="padding-top:0px">
					<form class="form-horizontal" action="<?php echo U('setting/sms');?>" method="post">
						<table class="table" style="margin-left:10px;">
							<tbody class="form-inline">				
								<tr>
									<th colspan="2"><span style="font-weight:900;line-height:40px;"><?php echo L('SMS_CONFIGURATION_INFORMATION');?></span></th>
								</tr>
								<tr>
									<td style="width:150px;" class="tdleft"><?php echo L('THE_USER_NAME_TEXT_INTERFACE');?></td>  
									<td >
										<input name="uid" id="uid" type="text" class="form-control" value="<?php echo ($sms['uid']); ?>"/>
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft"><?php echo L('SMS_INTERFACE_PASSWORD');?></td>  
									<td style="border:none">
										<input value="<?php echo ($sms['passwd']); ?>" id="passwd" class="form-control" name="passwd" type="password">
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft"><?php echo L('CUSTOMER_MESSAGE_SIGNATURE');?></td>  
									<td style="border:none">
										<input value="<?php echo ($sms['sign_name']); ?>" maxlength="8" id="sign_name" name="sign_name" type="text" class="form-control">
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft"><?php echo L('INTERNAL_NOTIFICATION_MESSAGE_SIGNATURE');?></td>  
									<td style="border:none">
										<input value="<?php echo ($sms['sign_sysname']); ?>" maxlength="8" id="sign_sysname" name="sign_sysname" type="text" class="form-control">
									</td>
								</tr>
								<tr>
									<td style="border:none" class="tdleft"><?php echo L('TEST_PHONE');?></td>  
									<td style="border:none">
										<input name="test_sms_phone" id="test_sms_phone" type="text" class="form-control"/> &nbsp; <input style="background:#fff;border:1px solid #e3e3e3;color:#000;" class="btn btn-primary btn-sm" id="test_sms_btn" type="button" value="<?php echo L('SEND_TEST_SMS');?>"/>
									</td>
								</tr>
	...
	$('#test_sms_btn').click(
		function(){
			...
			if(uid !='' && passwd !='' && phone !=''){
				...
				alert_crm('<?php echo L("PLEASE_FILL_IN_COMPLETE_INFORMATION");?>','warning');
			}
		}
	);
</script>
