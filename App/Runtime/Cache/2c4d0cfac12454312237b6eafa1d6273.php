                                    ...
                                    <div class="nav pull-left" style="margin:2px 0 0 15px;width: 165px;margin-right: 20px;">
                                        <div class="input-group">
                                            <select class="form-control input-sm " style="min-width:165px;max-width: 165px;" name="field" >
                                                <option value="pro_type" <?php if($field == pro_type): ?>selected<?php endif; ?> >项目类型</option>
                                                <option value="industry" <?php if($field == industry): ?>selected<?php endif; ?> >行业</option>
                                                <option value="location" <?php if($field == location): ?>selected<?php endif; ?>>城市</option>
