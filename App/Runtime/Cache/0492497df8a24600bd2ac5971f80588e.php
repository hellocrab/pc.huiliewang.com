				...
				<div class="ibox-content">
					...
					<div class="pull-right" >
						<p style="font-size: 14px;">
							<a class="btn btn-primary btn-sm" href="<?php echo U('user/edit','id=' . $user['user_id']);?>"><?php echo L('EDIT');?></a>
							<a class="btn btn-primary btn-sm" href="javascript:void(0)" onclick="javascript:history.go(-1)"><?php echo L('RETURN');?></a>
						</p>
					</div>
					<div class="row">
						<div class="col-sm-12">
									...
									<table class="table" width="95%" border="0" cellspacing="1" cellpadding="0">
										<tbody>
											...
											<tr>
												...
												<td >
													<?php if($user['img'] != ''): ?><a href="<?php echo ($user['img']); ?>" class="litebox" >
															<img src="<?php echo ($user["img"]); ?>" style="height:70px;width:70px;margin-bottom: 0px;" class="thumbnail img"/>
														</a>
													<?php else: ?>
												...
												<td <?php if(C('ismobile') != 1): ?>colspan="3"<?php endif; ?>>
													<?php if($user['status'] == 0): echo L('UNAUDITED');?>
													...
													未激活<?php endif; ?>
													<?php if(C('CALL_CENTER') == 1): ?>（坐席号：<?php if($user['extid'] > 0): echo ($user["extid"]); else: ?>无<?php endif; ?>）<?php endif; ?>
												</td>
											</tr>
											<tr>
												<td class="tdleft" width="15%"><?php echo L('USER_NAME');?> :</td>
												<td width="35%">
													<?php echo ($user["login_name"]); ?>(
													<?php if(is_array($categoryList)): $i = 0; $__LIST__ = $categoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$temp): $mod = ($i % 2 );++$i; if($temp["category_id"] == $user['category_id']): echo ($temp["name"]); endif; endforeach; endif; else: echo "" ;endif; ?>)
												</td>
											...
											<tr>
												...
												<?php if(C('ismobile') == 1): ?></tr><tr><?php endif; ?>
												<td  class="tdleft" width="15%">英文名： </td>
												<td width="35%"><?php echo ($user["second_name"]); ?></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><a href="tel:<?php echo ($user["office_tel"]); ?>"><?php echo ($user["office_tel"]); ?></a></td>
											</tr>
											<tr>
												<?php if(C('ismobile') == 1): ?></tr><tr><?php endif; ?>
											...
											<tr>
												...
												<td><?php echo ($user["entry"]); ?></td>
											</tr>
											<tr>
												<td class="tdleft"><?php echo L('ADDRESS');?> :</td>
												<td ><?php echo ($user["address"]); ?></td>
												<?php if($customer_num == 1): ?><td class="tdleft">客户数量 :</td>
													<td ><?php echo ($user["customer_num"]); ?></td><?php endif; ?>
											</tr>
											<tr>
												<td class="tdleft">自我介绍 :</td>
												<td <?php if(C('ismobile') != 1): ?>colspan="3"<?php endif; ?>><?php echo ($user["introduce"]); ?></td>
											</tr>
										</tbody>
									</table>
								</div>
